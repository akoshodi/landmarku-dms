        ...
        <ul class="header-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    ...
                    <a class="dropdown-item" href="javascript:void(0)">
                        <svg class="icon me-2">
                            <use xlink:href="assets/vendors/@coreui/icons/svg/free.svg#cil-credit-card">
                            </use>
                        </svg>
                        Payments
                        <span class="badge badge-sm bg-secondary ms-2">
                            42
                        </span>
                    </a>
                    <a class="dropdown-item" href="javascript:void(0)">
                        <svg class="icon me-2">
                            <use xlink:href="assets/vendors/@coreui/icons/svg/free.svg#cil-file">
                            </use>
                        </svg>
                        Projects
