<html lang="en" data-coreui-theme="light"><head>
    <base href="./">
    <meta charset="utf-8">
    ...
    <div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
      ...
      <ul class="sidebar-nav simplebar-scrollable-y" data-coreui="navigation" data-simplebar="init"><div class="simplebar-wrapper" style="margin: -8px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 8px;">
        <li class="nav-item"><a class="nav-link active" href="index.html">
            <svg class="nav-icon">
              <use xlink:href="assets/vendors/@coreui/icons/svg/cil-speedometer.svg"></use>
          ...
          <div class="row g-4 mb-4">
            <div class="col-sm-6 col-xl-3">
              <div class="card text-white bg-primary">
                ...
                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                  <canvas class="chart" id="card-chart1" height="105" style="display: block; box-sizing: border-box; height: 70px; width: 188px;" width="282"></canvas>
                </div>
              </div>
            </div>
            <!-- /.col-->
            <div class="col-sm-6 col-xl-3">
              <div class="card text-white bg-info">
                ...
                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                  <canvas class="chart" id="card-chart2" height="105" style="display: block; box-sizing: border-box; height: 70px; width: 188px;" width="282"></canvas>
                </div>
              </div>
            </div>
            <!-- /.col-->
            <div class="col-sm-6 col-xl-3">
              <div class="card text-white bg-warning">
                ...
                <div class="c-chart-wrapper mt-3" style="height:70px;">
                  <canvas class="chart" id="card-chart3" height="105" style="display: block; box-sizing: border-box; height: 70px; width: 220px;" width="330"></canvas>
                <div class="chartjs-tooltip" style="opacity: 0; left: 73.3333px; top: 106px;"><table style="margin: 0px;"><thead class="chartjs-tooltip-header"><tr style="border-width: 0px;" class="chartjs-tooltip-header-item"><th style="border-width: 0px;">March</th></tr></thead><tbody class="chartjs-tooltip-body"><tr class="chartjs-tooltip-body-item"><td style="border-width: 0px;"><span style="background: rgba(255, 255, 255, 0.2); border-color: rgba(255, 255, 255, 0.55); border-width: 2px; margin-right: 10px; height: 10px; width: 10px; display: inline-block;"></span>My First dataset: 80</td></tr></tbody></table></div></div>
              </div>
            </div>
            <!-- /.col-->
            <div class="col-sm-6 col-xl-3">
              <div class="card text-white bg-danger">
                ...
                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                  <canvas class="chart" id="card-chart4" height="105" style="display: block; box-sizing: border-box; height: 70px; width: 188px;" width="282"></canvas>
                </div>
              </div>
            </div>
            <!-- /.col-->
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                <canvas class="chart" id="main-chart" height="450" style="display: block; box-sizing: border-box; height: 300px; width: 925px;" width="1387"></canvas>
              </div>
            </div>
